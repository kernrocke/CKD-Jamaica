...
*Interaction Analysis Log GFR Schwartz

*Interaction for Sex

*Model 1
xtmixed log_GFR_SW sex_new#c.bwt_std sex_new#c.blength sex_new#c.gestage_new sex_new#c.q112age  if ckd_miss== 0, || place_birth :,  covariance(identity)
contrast sex_new#c.bwt_std sex_new#c.blength sex_new#c.gestage_new sex_new#c.q112age

*Model 2

xtmixed log_GFR_SW sex_new#c.bwt_std sex_new#c.blength sex_new#c.gestage_new sex_new#c.q112age sex_new#c.bmi sex_new#c.own_education sex_new#c.own_occup_cat2 if ckd_miss== 0, || place_birth :,  covariance(identity)
...
xtmixed log_GFR_SW bwt_std blength gestage_new sex_new#c.q112age sex_new#c.bmi sex_new#c.own_education sex_new#c.own_occup_cat2 sex_new#c.ageatbrth sex_new#c.edcat3 sex_new#c.occ_cat_mom1a sex_new#c.htn_preg sex_new#c.smoker if ckd_miss== 0, || place_birth :,  covariance(identity)
...
xtmixed log_GFR_SW bwt_std blength gestage_new sex_new sex_new#c.q112age sex_new#c.bmi sex_new#c.own_education sex_new#c.own_occup_cat2 sex_new#c.mn23sbp2 sex_new#c.q115chol sex_new#c.q116fat sex_new#c.fastglu sex_new#c.q47smok1 if ckd_miss== 0, || place_birth :,  covariance(identity)
...
xtmixed log_GFR_SW bwt_std blength gestage_new sex_new sex_new#c.q112age sex_new#c.bmi sex_new#c.own_education sex_new#c.own_occup_cat2 sex_new#c.mn23dbp2 sex_new#c.q115chol sex_new#c.q116fat sex_new#c.fastglu sex_new#c.q47smok1 if ckd_miss== 0, || place_birth :,  covariance(identity)
...
xtmixed log_GFR_SW own_education#c.bwt_std own_education#c.blength own_education#c.gestage_new own_education#c.sex_new own_education#c.q112age if ckd_miss== 0, || place_birth :,  covariance(identity)
...
xtmixed log_GFR_SW own_education#c.bwt_std own_education#c.blength own_education#c.gestage_new own_education#c.sex_new own_education#c.q112age own_education#c.bmi i.own_education own_education#c.own_occup_cat2 if ckd_miss== 0, || place_birth :,  covariance(identity)
...
xtmixed log_GFR_SW own_occup_cat2#c.bwt_std own_occup_cat2#c.blength own_occup_cat2#c.gestage_new own_occup_cat2#c.sex_new own_occup_cat2#c.q112age if ckd_miss== 0, || place_birth :,  covariance(identity)
...
xtmixed log_GFR_SW own_occup_cat2#c.bwt_std own_occup_cat2#c.blength own_occup_cat2#c.gestage_new own_occup_cat2#c.sex_new own_occup_cat2#c.q112age own_occup_cat2#c.bmi own_occup_cat2#c.own_education i.own_occup_cat2 if ckd_miss== 0, || place_birth :,  covariance(identity)
